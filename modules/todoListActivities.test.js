...
describe("AvailableActivities", () => {
    ...
    describe("modifyActivity", () => {
        ...
        <div>
          <p class="d1">Activity 1</p>
          <p class="d2">Activity 2</p>
          <p class="d3">Activity 3</p>
        </div>
      `;
        });

        // Test 6
        test("should modify the description of the specified activity and update localStorage", () => {
            const initialActivities = [
                { description: "Activity 1", completed: false, index: 1 },
                { description: "Activity 2", completed: false, index: 2 },
                { description: "Activity 3", completed: false, index: 3 },
            ...
            expect(storedActivities[1].description).toBe("Modified Activity");
        });

        // Test 7
        test("should update the DOM with the modified activity description", () => {
            const initialActivities = [
                { description: "Activity 1", completed: false, index: 1 },
                { description: "Activity 2", completed: false, index: 2 },
                { description: "Activity 3", completed: false, index: 3 },
            ...
            const modifiedActivityElement = document.querySelector(".d2");
            expect(modifiedActivityElement.innerHTML).toBe("Modified Activity");
        });
    });
});
